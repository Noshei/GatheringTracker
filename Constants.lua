...
local ItemData = {
    ...
    DF = {
        Herb = {
            {id = 191462, name = "Hochenblume", order = 1},
            {id = 191468, name = "Bubble Poppy", order = 2},
            {id = 191470, name = "Writhebark", order = 3},
            {id = 191464, name = "Saxifrage", order = 4},
            {id = -1, name = "Other", order = 5},
            {id = 197757, name = "Assorted Exotic Spices", order = 6},
            {id = 197755, name = "Lava Beetle", order = 7},
        },
        Ore = {
            {id = 190394, name = "Tyrivite Ore", order = 1},
            {id = 188658, name = "Draconium Ore", order = 2},
            {id = 190313, name = "Khazgorite Ore", order = 3},
            {id = -1, name = "Other", order = 4},
            {id = 197754, name = "Salt Deposit", order = 5},
        },
        Cloth = {
        ...
        Leather = {
            {id = 193208, name = "Resilient Leather", order = 1},
            {id = 193251, name = "Crystalspine Fur", order = 2},
            {id = 193254, name = "Rockfang Leather", order = 3},
            {id = -1, name = "Hide", order = 4},
            {id = 193258, name = "Fire Infused Hide", order = 5},
            {id = 193216, name = "Dense Hide", order = 6},
            {id = -1, name = "Scales", order = 7},
            {id = 193213, name = "Adamant Scales", order = 8},
            {id = 193252, name = "Salamanther Scales", order = 9},
            {id = 193253, name = "Cacophonous Thunderscale", order = 10},
            {id = 193222, name = "Lustrous Scales", order = 11},
            {id = 193259, name = "Flawless Proto Dragon Scale", order = 12},
            {id = -1, name = "Other", order = 13},
            {id = 193261, name = "Bite Sized Morsel", order = 14},
            {id = 193262, name = "Exceptional Morsel", order = 15},
            {id = 193255, name = "Pristine Vorquin Horn", order = 16},
            {id = 193256, name = "Windsong Plumage", order = 17},
        },
        Meat = {
            {id = 197745, name = "Basilisk Eggs", order = 1},
            {id = 197746, name = "Bruffalon Flank", order = 2},
            {id = 197748, name = "Burly Bear Meat", order = 3},
            {id = 197743, name = "Duck Meat", order = 4},
        ...
        Gem = {
            {id = 192872, name = "Fractured Glass", order = 1},
            {id = 193368, name = "Finely Ground Gemstones", order = 2},
            {id = -1, name = "Uncommon Gems", order = 3},
            {id = 192838, name = "Queens Ruby", order = 4},
            {id = 192851, name = "Eternity Amber", order = 5},
            {id = 192845, name = "Vibrant Emerald", order = 6},
            {id = 192840, name = "Mystic Sapphire", order = 7},
            {id = 192847, name = "Sundered Onyx", order = 8},
            {id = -1, name = "Rare Gems", order = 9},
            {id = 192852, name = "Alexstraszite", order = 10},
            {id = 192867, name = "Nozdorite", order = 11},
            {id = 192860, name = "Ysemerald", order = 12},
            {id = 192856, name = "Malygite", order = 13},
            {id = 192863, name = "Neltharite", order = 14},
            {id = -1, name = "Epic Gems", order = 15},
            {id = 192869, name = "Illimited Diamond", order = 16},
        },
        Enchanting = {
        ...
        Pigment = {
            {id = 198418, name = "Blazing Pigment", order = 1},
            {id = 198416, name = "Flourishing Pigment", order = 2},
            {id = 198413, name = "Serene Pigment", order = 3},
            {id = 198422, name = "Shimmering Pigment", order = 4},
        },
        Other = {
