...
local ItemData = {
    ...
    DF = {
        ...
        Elemental = {
            ...
            {id = 190451, name = "Rousing Blood", order = 2},
            {id = 190330, name = "Rousing Decay", order = 3},
            {id = 190315, name = "Rousing Earth", order = 4},
            {id = 190320, name = "Rousing Fire", order = 5},
            {id = 190328, name = "Rousing Frost", order = 6},
            {id = 190322, name = "Rousing Order", order = 7},
            {id = 190327, name = "Awakened Air", order = 8},
            {id = 190450, name = "Awakened Blood", order = 9},
            ...
            {id = 190324, name = "Awakened Order", order = 14},       
        },
        Gem = {
