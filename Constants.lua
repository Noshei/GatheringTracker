...
local ItemData = {
    ...
    DF = {
        ...
        Leather = {
            ...
            {id = -1, name = "Hide", order = 6},
            {id = 193216, name = "Dense Hide", order = 7, quality = 1},
            {id = 193217, name = "Dense Hide", order = 8, quality = 2},
            {id = 193218, name = "Dense Hide", order = 9, quality = 3},
            {id = 193258, name = "Fire Infused Hide", order = 10},
            {id = -1, name = "Scales", order = 11},
            {id = 193213, name = "Adamant Scales", order = 12, quality = 1},
            {id = 193214, name = "Adamant Scales", order = 13, quality = 2},
            {id = 193215, name = "Adamant Scales", order = 14, quality = 3},
            {id = 193222, name = "Lustrous Scaled Hide", order = 15, quality = 1},
            {id = 193223, name = "Lustrous Scaled Hide", order = 16, quality = 2},
            {id = 193224, name = "Lustrous Scaled Hide", order = 17, quality = 3},
            {id = 193252, name = "Salamanther Scales", order = 18},
            {id = 193253, name = "Cacophonous Thunderscale", order = 19},
            {id = 193259, name = "Flawless Proto Dragon Scale", order = 20},
            {id = -1, name = "Other", order = 21},
            {id = 193261, name = "Bite Sized Morsel", order = 22},
            {id = 193262, name = "Exceptional Morsel", order = 23},
            {id = 193255, name = "Pristine Vorquin Horn", order = 24},
            {id = 193256, name = "Windsong Plumage", order = 25},
        },
        Meat = {
