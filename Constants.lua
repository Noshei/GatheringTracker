...
local ItemData = {
    Classic = {
        ...
        Leather = {
            ...
            { id = 15419, name = "Warbear Leather", order = 6 },
            { id = 783, name = "Light Hide", order = 7 },
            { id = 4232, name = "Medium Hide", order = 8 },
            { id = 4235, name = "Heavy Hide", order = 9 },
            { id = 8169, name = "Thick Hide", order = 10 },
    ...
    BFA = {
        ...
        Gem = {
            ...
            { id = 168189, name = "Dark Opal", order = 19 },
            { id = 168191, name = "Sea Currant", order = 20 },
            { id = -1, name = "Other", order = 21 },
    ...
    DF = {
        Herb = {
            { id = 191460, name = "Hochenblume", order = 1, quality = 1 },
            { id = 191461, name = "Hochenblume", order = 2, quality = 2 },
            { id = 191462, name = "Hochenblume", order = 3, quality = 3 },
            { id = 191467, name = "Bubble Poppy", order = 4, quality = 1 },
            { id = 191468, name = "Bubble Poppy", order = 5, quality = 2 },
            { id = 191469, name = "Bubble Poppy", order = 6, quality = 3 },
            { id = 191470, name = "Writhebark", order = 7, quality = 1 },
            { id = 191471, name = "Writhebark", order = 8, quality = 2 },
            { id = 191472, name = "Writhebark", order = 9, quality = 3 },
            { id = 191464, name = "Saxifrage", order = 10, quality = 1 },
            { id = 191465, name = "Saxifrage", order = 11, quality = 2 },
            { id = 191466, name = "Saxifrage", order = 12, quality = 3 },
            { id = -1, name = "Other", order = 13 },
            { id = 197757, name = "Assorted Exotic Spices", order = 14 },
            { id = 197755, name = "Lava Beetle", order = 15 },
        },
        Ore = {
            { id = 190395, name = "Serevite Ore", order = 1, quality = 1 },
            { id = 190396, name = "Serevite Ore", order = 2, quality = 2 },
            { id = 190394, name = "Serevite Ore", order = 3, quality = 3 },
            { id = 189143, name = "Draconium Ore", order = 4, quality = 1 },
            { id = 188658, name = "Draconium Ore", order = 5, quality = 2 },
            { id = 190311, name = "Draconium Ore", order = 6, quality = 3 },
            { id = 190312, name = "Khazgorite Ore", order = 7, quality = 1 },
            { id = 190313, name = "Khazgorite Ore", order = 8, quality = 2 },
            { id = 190314, name = "Khazgorite Ore", order = 9, quality = 3 },
            { id = -1, name = "Other", order = 10 },
            { id = 197754, name = "Salt Deposit", order = 11 },
        },
        Cloth = {
            { id = 193050, name = "Tattered Wildercloth", order = 1 },
            { id = 193922, name = "Wildercloth", order = 2 },
            { id = 193924, name = "Frostbitten Wildercloth", order = 3 },
            { id = 193923, name = "Decayed Wildercloth", order = 4 },
            { id = 193925, name = "Singed Wildercloth", order = 5 },
        },
        Leather = {
            { id = 193208, name = "Resilient Leather", order = 1, quality = 1 },
            { id = 193210, name = "Resilient Leather", order = 2, quality = 2 },
            { id = 193211, name = "Resilient Leather", order = 3, quality = 3 },
            { id = 193251, name = "Crystalspine Fur", order = 4 },
            { id = 193254, name = "Rockfang Leather", order = 5 },
            { id = 205413, name = "Obsidian Cobraskin", order = 6 },
            { id = -1, name = "Hide", order = 7 },
            { id = 193216, name = "Dense Hide", order = 8, quality = 1 },
            { id = 193217, name = "Dense Hide", order = 9, quality = 2 },
            { id = 193218, name = "Dense Hide", order = 10, quality = 3 },
            { id = 193258, name = "Fire Infused Hide", order = 11 },
            { id = -1, name = "Scales", order = 12 },
            { id = 193213, name = "Adamant Scales", order = 13, quality = 1 },
            { id = 193214, name = "Adamant Scales", order = 14, quality = 2 },
            { id = 193215, name = "Adamant Scales", order = 15, quality = 3 },
            { id = 193222, name = "Lustrous Scaled Hide", order = 16, quality = 1 },
            { id = 193223, name = "Lustrous Scaled Hide", order = 17, quality = 2 },
            { id = 193224, name = "Lustrous Scaled Hide", order = 18, quality = 3 },
            { id = 193252, name = "Salamanther Scales", order = 19 },
            { id = 193253, name = "Cacophonous Thunderscale", order = 20 },
            { id = 193259, name = "Flawless Proto Dragon Scale", order = 21 },
            { id = -1, name = "Other", order = 22 },
            { id = 193261, name = "Bite Sized Morsel", order = 23 },
        ...
        Meat = {
            ...
            { id = 197746, name = "Bruffalon Flank", order = 2 },
            { id = 197748, name = "Burly Bear Meat", order = 3 },
            { id = 197743, name = "Waterfowl Filet", order = 4 },
            { id = 197744, name = "Hornswog Hunk", order = 5 },
            { id = 197741, name = "Maybe Meat", order = 6 },
            { id = 197747, name = "Mighty Mammoth Ribs", order = 7 },
            { id = 197742, name = "Ribbed Mollusk Meat", order = 8 },
        },
        Fish = {
            { id = 194967, name = "Aileron Seamoth", order = 1 },
            { id = 194968, name = "Cerulean Spinefish", order = 2 },
            { id = 194969, name = "Temporal Dragonhead", order = 3 },
            { id = 194966, name = "Thousandbite Piranha", order = 4 },
            { id = 194730, name = "Scalebelly Mackerel", order = 5 },
            { id = 194970, name = "Islefin Dorado", order = 6 },
            { id = 200061, name = "Prismatic Leaper", order = 7 },
            { id = 200074, name = "Frosted Rimefin Tuna", order = 8 },
            { id = 199344, name = "Magma Thresher", order = 9 },
            { id = -1, name = "Coins", order = 10 },
            { id = 199338, name = "Copper Coin Of The Isles", order = 11 },
            { id = 199339, name = "Silver Coin Of The Isles", order = 12 },
            { id = 199340, name = "Gold Coin Of The Isles", order = 13 },
            { id = -1, name = "Other", order = 14 },
            { id = 198395, name = "Dull Spined Clam", order = 15 },
        },
        Elemental = {
            { id = 190326, name = "Rousing Air", order = 1 },
            { id = 190330, name = "Rousing Decay", order = 2 },
            { id = 190315, name = "Rousing Earth", order = 3 },
            { id = 190320, name = "Rousing Fire", order = 4 },
            { id = 190328, name = "Rousing Frost", order = 5 },
            { id = 190451, name = "Rousing Ire", order = 6 },
            { id = 190322, name = "Rousing Order", order = 7 },
            { id = -1, name = "Awakened", order = 8 },
            { id = 190327, name = "Awakened Air", order = 9 },
            { id = 190331, name = "Awakened Decay", order = 10 },
            { id = 190316, name = "Awakened Earth", order = 11 },
            { id = 190321, name = "Awakened Fire", order = 12 },
            { id = 190329, name = "Awakened Frost", order = 13 },
            { id = 190450, name = "Awakened Ire", order = 14 },
            { id = 190324, name = "Awakened Order", order = 15 },
        },
        Gem = {
            { id = 192880, name = "Crumbled Stone", order = 1 },
            { id = 192872, name = "Fractured Glass", order = 2 },
            { id = 193368, name = "Silken Gemdust", order = 3, quality = 1 },
            { id = 193369, name = "Silken Gemdust", order = 4, quality = 2 },
            { id = 193370, name = "Silken Gemdust", order = 5, quality = 3 },
            { id = -1, name = "Uncommon Gems", order = 6 },
            { id = 192837, name = "Queens Ruby", order = 7, quality = 1 },
            { id = 192838, name = "Queens Ruby", order = 8, quality = 2 },
            { id = 192839, name = "Queens Ruby", order = 9, quality = 3 },
            { id = 192849, name = "Eternity Amber", order = 10, quality = 1 },
            { id = 192850, name = "Eternity Amber", order = 11, quality = 2 },
            { id = 192851, name = "Eternity Amber", order = 12, quality = 3 },
            { id = 192843, name = "Vibrant Emerald", order = 13, quality = 1 },
            { id = 192844, name = "Vibrant Emerald", order = 14, quality = 2 },
            { id = 192845, name = "Vibrant Emerald", order = 15, quality = 3 },
            { id = 192840, name = "Mystic Sapphire", order = 16, quality = 1 },
            { id = 192841, name = "Mystic Sapphire", order = 17, quality = 2 },
            { id = 192842, name = "Mystic Sapphire", order = 18, quality = 3 },
            { id = 192846, name = "Sundered Onyx", order = 19, quality = 1 },
            { id = 192847, name = "Sundered Onyx", order = 20, quality = 2 },
            { id = 192848, name = "Sundered Onyx", order = 21, quality = 3 },
            { id = -1, name = "Rare Gems", order = 22 },
            { id = 192852, name = "Alexstraszite", order = 23, quality = 1 },
            { id = 192853, name = "Alexstraszite", order = 24, quality = 2 },
            { id = 192855, name = "Alexstraszite", order = 25, quality = 3 },
            { id = 192866, name = "Nozdorite", order = 26, quality = 1 },
            { id = 192867, name = "Nozdorite", order = 27, quality = 2 },
            { id = 192868, name = "Nozdorite", order = 28, quality = 3 },
            { id = 192859, name = "Ysemerald", order = 29, quality = 1 },
            { id = 192860, name = "Ysemerald", order = 30, quality = 2 },
            { id = 192861, name = "Ysemerald", order = 31, quality = 3 },
            { id = 192856, name = "Malygite", order = 32, quality = 1 },
            { id = 192857, name = "Malygite", order = 33, quality = 2 },
            { id = 192858, name = "Malygite", order = 34, quality = 3 },
            { id = 192862, name = "Neltharite", order = 35, quality = 1 },
            { id = 192863, name = "Neltharite", order = 36, quality = 2 },
            { id = 192865, name = "Neltharite", order = 37, quality = 3 },
            { id = -1, name = "Epic Gems", order = 38 },
            { id = 192869, name = "Illimited Diamond", order = 39, quality = 1 },
            { id = 192870, name = "Illimited Diamond", order = 40, quality = 2 },
            { id = 192871, name = "Illimited Diamond", order = 41, quality = 3 },
        },
        Enchanting = {
            { id = 194124, name = "Vibrant Shard", order = 1 },
            { id = 194123, name = "Chromatic Dust", order = 2 },
            { id = 200113, name = "Resonant Crystal", order = 3 },
        },
        Pigment = {
            { id = 198418, name = "Blazing Pigment", order = 1, quality = 1 },
            { id = 198419, name = "Blazing Pigment", order = 2, quality = 2 },
            { id = 198420, name = "Blazing Pigment", order = 3, quality = 3 },
            { id = 198415, name = "Flourishing Pigment", order = 4, quality = 1 },
            { id = 198416, name = "Flourishing Pigment", order = 5, quality = 2 },
            { id = 198417, name = "Flourishing Pigment", order = 6, quality = 3 },
            { id = 198412, name = "Serene Pigment", order = 7, quality = 1 },
            { id = 198413, name = "Serene Pigment", order = 8, quality = 2 },
            { id = 198414, name = "Serene Pigment", order = 9, quality = 3 },
            { id = 198421, name = "Shimmering Pigment", order = 10, quality = 1 },
            { id = 198422, name = "Shimmering Pigment", order = 11, quality = 2 },
            { id = 198423, name = "Shimmering Pigment", order = 12, quality = 3 },
        },
        Other = {
    ...
    TWW = {
        Herb = {
            { id = 210796, name = "Mycobloom", order = 1, quality = 1 },
            { id = 210797, name = "Mycobloom", order = 2, quality = 2 },
            { id = 210798, name = "Mycobloom", order = 3, quality = 3 },
            { id = 210805, name = "Blessing Blossom", order = 4, quality = 1 },
            { id = 210806, name = "Blessing Blossom", order = 5, quality = 2 },
            { id = 210807, name = "Blessing Blossom", order = 6, quality = 3 },
            { id = 210808, name = "Arathors Spear", order = 7, quality = 1 },
            { id = 210809, name = "Arathors Spear", order = 8, quality = 2 },
            { id = 210810, name = "Arathors Spear", order = 9, quality = 3 },
            { id = 210799, name = "Luredrop", order = 10, quality = 1 },
            { id = 210800, name = "Luredrop", order = 11, quality = 2 },
            { id = 210801, name = "Luredrop", order = 12, quality = 3 },
            { id = 210802, name = "Orbinid", order = 13, quality = 1 },
            { id = 210803, name = "Orbinid", order = 14, quality = 2 },
            { id = 210804, name = "Orbinid", order = 15, quality = 3 },
            { id = 213610, name = "Crystalline Powder", order = 16 },
            { id = 213613, name = "Leyline Residue", order = 17 },
        ...
        Ore = {
            ...
            { id = 210931, name = "Bismuth", order = 2, quality = 2 },
            { id = 210932, name = "Bismuth", order = 3, quality = 3 },
            { id = 210933, name = "Aqirite", order = 4, quality = 1 },
            { id = 210934, name = "Aqirite", order = 5, quality = 2 },
            { id = 210935, name = "Aqirite", order = 6, quality = 3 },
            { id = 210936, name = "Ironclaw Ore", order = 7, quality = 1 },
            { id = 210937, name = "Ironclaw Ore", order = 8, quality = 2 },
            { id = 210938, name = "Ironclaw Ore", order = 9, quality = 3 },
            { id = -1, name = "Other", order = 10 },
            { id = 217707, name = "Imperfect Null Stone", order = 11 },
            { id = 210939, name = "Null Stone", order = 12 },
        },
        Cloth = {
            { id = 224826, name = "Dawnweave", order = 1, quality = 1 },
            { id = 228235, name = "Dawnweave", order = 2, quality = 2 },
            { id = 228236, name = "Dawnweave", order = 3, quality = 3 },
            { id = 224824, name = "Duskweave", order = 4, quality = 1 },
            { id = 228233, name = "Duskweave", order = 5, quality = 2 },
            { id = 228234, name = "Duskweave", order = 6, quality = 3 },
            { id = 224828, name = "Weavercloth", order = 7, quality = 1 },
            { id = 228231, name = "Weavercloth", order = 8, quality = 2 },
            { id = 228232, name = "Weavercloth", order = 9, quality = 3 },
        },
        Leather = {
            { id = 212664, name = "Stormcharged Leather", order = 1, quality = 1 },
            { id = 212665, name = "Stormcharged Leather", order = 2, quality = 2 },
            { id = 212666, name = "Stormcharged Leather", order = 3, quality = 3 },
            { id = -1, name = "Hide", order = 4 },
            { id = 212670, name = "Thunderous Hide", order = 5, quality = 1 },
            { id = 212672, name = "Thunderous Hide", order = 6, quality = 2 },
            { id = 212673, name = "Thunderous Hide", order = 7, quality = 3 },
            { id = 221757, name = "Gloomfathom Hide", order = 8 },
            { id = -1, name = "Scales", order = 9 },
            { id = 212667, name = "Gloom Chitin", order = 10, quality = 1 },
            { id = 212668, name = "Gloom Chitin", order = 11, quality = 2 },
            { id = 212669, name = "Gloom Chitin", order = 12, quality = 3 },
            { id = 212674, name = "Sunless Carapace", order = 13, quality = 1 },
            { id = 212675, name = "Sunless Carapace", order = 14, quality = 2 },
            { id = 212676, name = "Sunless Carapace", order = 15, quality = 3 },
            { id = -1, name = "Other", order = 16 },
            { id = 218338, name = "Bottled Storm", order = 17 },
            { id = 218339, name = "Burning Cinderbee Setae", order = 18 },
            { id = 218337, name = "Honed Bone Shards", order = 19 },
            { id = 218336, name = "Kaheti Swarm Chitin", order = 20 },
            { id = 219013, name = "Superb Beast Fang", order = 21 },
        },
        Meat = {
            { id = 223512, name = "Basically Beef", order = 1 },
            { id = 225567, name = "Bug Brisket", order = 2 },
            { id = 222737, name = "Chopped Mycobloom", order = 3 },
            { id = 225911, name = "Cinderbee Belly", order = 4 },
            { id = 225569, name = "Clipped Bird Wing", order = 5 },
            { id = 225565, name = "Massive Worm Flank", order = 6 },
            { id = 225566, name = "Warped Wing", order = 7 },
        },
        Fish = {
            { id = 220137, name = "Bismuth Bitterling", order = 1 },
            { id = 220135, name = "Bloody Perch", order = 2 },
            { id = 220136, name = "Crystalline Sturgeon", order = 3 },
            { id = 220134, name = "Dilly Dally Dace", order = 4 },
            { id = 220145, name = "Arathor Hammerfish", order = 5 },
            { id = 220143, name = "Dornish Pike", order = 6 },
            { id = 222533, name = "Goldengill Trout", order = 7 },
            { id = 220147, name = "Kaheti Slum Shark", order = 8 },
            { id = 220138, name = "Nibbling Minnow", order = 9 },
            { id = 220148, name = "Pale Huskfish", order = 10 },
            { id = 220142, name = "Quiet River Bass", order = 11 },
            { id = 220144, name = "Roaring Anglerseeker", order = 12 },
            { id = 220141, name = "Specular Rainbowfish", order = 13 },
            { id = 220139, name = "Whispering Stargazer", order = 14 },
            { id = 225568, name = "Slum Shark Scrap", order = 15 },
            { id = 220153, name = "Awoken Coelacanth", order = 16 },
            { id = 220152, name = "Cursed Ghoulfish", order = 17 },
            { id = 220151, name = "Queens Lurefish", order = 18 },
            { id = 220146, name = "Regal Dottyback", order = 19 },
            { id = 220149, name = "Sanguine Dogfish", order = 20 },
            { id = 220150, name = "Spiked Sea Raven", order = 21 },
        },
        Gem = {
            { id = 213750, name = "Engraved Gemcutter", order = 1, quality = 1 },
            { id = 213751, name = "Engraved Gemcutter", order = 2, quality = 2 },
            { id = 213752, name = "Engraved Gemcutter", order = 3, quality = 3 },
            { id = 213756, name = "Marbled Stone", order = 4, quality = 1 },
            { id = 213757, name = "Marbled Stone", order = 5, quality = 2 },
            { id = 213758, name = "Marbled Stone", order = 6, quality = 3 },
            { id = 213753, name = "Decorative Lens", order = 7, quality = 1 },
            { id = 213754, name = "Decorative Lens", order = 8, quality = 2 },
            { id = 213755, name = "Decorative Lens", order = 9, quality = 3 },
            { id = 213398, name = "Handful Of Pebbles", order = 10 },
            { id = 213399, name = "Glittering Glass", order = 11 },
            { id = 213219, name = "Crushed Gemstones", order = 12, quality = 1 },
            { id = 213220, name = "Crushed Gemstones", order = 13, quality = 2 },
            { id = 213221, name = "Crushed Gemstones", order = 14, quality = 3 },
            { id = 212498, name = "Ambivalent Amber", order = 15 },
            { id = 212505, name = "Extravagant Emerald", order = 16 },
            { id = 212511, name = "Ostentatious Onyx", order = 17 },
            { id = 212495, name = "Radiant Ruby", order = 18 },
            { id = 212508, name = "Stunning Sapphire", order = 19 },
        },
        Enchanting = {
            { id = 219946, name = "Storm Dust", order = 1, quality = 1 },
            { id = 219947, name = "Storm Dust", order = 2, quality = 2 },
            { id = 219948, name = "Storm Dust", order = 3, quality = 3 },
            { id = 219949, name = "Gleaming Shard", order = 4, quality = 1 },
            { id = 219950, name = "Gleaming Shard", order = 5, quality = 2 },
            { id = 219951, name = "Gleaming Shard", order = 6, quality = 3 },
            { id = 219952, name = "Refulgent Crystal", order = 7, quality = 1 },
            { id = 219954, name = "Refulgent Crystal", order = 8, quality = 2 },
            { id = 219955, name = "Refulgent Crystal", order = 9, quality = 3 },
        },
        Pigment = {
            { id = 222618, name = "Nacreous Pigment", order = 1, quality = 1 },
            { id = 222619, name = "Nacreous Pigment", order = 2, quality = 2 },
            { id = 222620, name = "Nacreous Pigment", order = 3, quality = 3 },
            { id = 224805, name = "Blossom Pigment", order = 4, quality = 1 },
            { id = 224804, name = "Blossom Pigment", order = 5, quality = 2 },
            { id = 224803, name = "Blossom Pigment", order = 6, quality = 3 },
            { id = 222612, name = "Luredrop Pigment", order = 7, quality = 1 },
            { id = 222613, name = "Luredrop Pigment", order = 8, quality = 2 },
            { id = 222614, name = "Luredrop Pigment", order = 9, quality = 3 },
            { id = 224802, name = "Orbinid Pigment", order = 10, quality = 1 },
            { id = 224801, name = "Orbinid Pigment", order = 11, quality = 2 },
            { id = 224800, name = "Orbinid Pigment", order = 12, quality = 3 },
        },
        Knowledge = {
            { id = -1, name = "Alchemy", order = 1 },
            { id = 226265, name = "Earthen Iron Powder", order = 2, clickable = true },
            { id = 226266, name = "Metal Dornogal Frame", order = 3, clickable = true },
            { id = 226268, name = "Engraved Stirring Rod", order = 4, clickable = true },
            { id = 226267, name = "Reinforced Beaker", order = 5, clickable = true },
            { id = 226269, name = "Chemists Purified Water", order = 6, clickable = true },
            { id = 226270, name = "Sanctified Mortar And Pestle", order = 7, clickable = true },
            { id = 226272, name = "Dark Apothecarys Vial", order = 8, clickable = true },
            { id = 226271, name = "Nerubian Mixing Salts", order = 9, clickable = true },
            { id = -1, name = "Blacksmithing", order = 10 },
            { id = 226277, name = "Dornogal Hammer", order = 11, clickable = true },
            { id = 226276, name = "Ancient Earthen Anvil", order = 12, clickable = true },
            { id = 226278, name = "Ringing Hammer Vise", order = 13, clickable = true },
            { id = 226279, name = "Earthen Chisels", order = 14, clickable = true },
            { id = 226281, name = "Radiant Tongs", order = 15, clickable = true },
            { id = 226280, name = "Holy Flame Forge", order = 16, clickable = true },
            { id = 226283, name = "Spiderlings Wire Brush", order = 17, clickable = true },
            { id = 226282, name = "Nerubian Smiths Kit", order = 18, clickable = true },
            { id = -1, name = "Enchanting", order = 19 },
            { id = 226285, name = "Silver Dornogal Rod", order = 20, clickable = true },
            { id = 226284, name = "Grinded Earthen Gem", order = 21, clickable = true },
            { id = 226287, name = "Animated Enchanting Dust", order = 22, clickable = true },
            { id = 226286, name = "Soot Coated Orb", order = 23, clickable = true },
            { id = 226289, name = "Enchanted Arathi Scroll", order = 24, clickable = true },
            { id = 226288, name = "Essence Of Holy Fire", order = 25, clickable = true },
            { id = 226291, name = "Void Shard", order = 26, clickable = true },
            { id = 226290, name = "Book Of Dark Magic", order = 27, clickable = true },
            { id = -1, name = "Engineering", order = 28 },
            { id = 226293, name = "Dornogal Spectacles", order = 29, clickable = true },
            { id = 226292, name = "Rock Engineers Wrench", order = 30, clickable = true },
            { id = 226295, name = "Earthen Construct Blueprints", order = 31, clickable = true },
            { id = 226294, name = "Inert Mining Bomb", order = 32, clickable = true },
            { id = 226297, name = "Arathi Safety Gloves", order = 33, clickable = true },
            { id = 226296, name = "Holy Firework Dud", order = 34, clickable = true },
            { id = 226298, name = "Puppeted Mechanical Spider", order = 35, clickable = true },
            { id = 226299, name = "Emptied Venom Canister", order = 36, clickable = true },
            { id = -1, name = "Herbalism", order = 37 },
            { id = 224264, name = "Deepgrove Petal", order = 38, clickable = true },
            { id = 224835, name = "Deepgrove Roots", order = 39, clickable = true },
            { id = 224265, name = "Deepgrove Rose", order = 40, clickable = true },
            { id = 226301, name = "Dornogal Gardening Scythe", order = 41, clickable = true },
            { id = 226300, name = "Ancient Flower", order = 42, clickable = true },
            { id = 226303, name = "Fungarian Slicers Knife", order = 43, clickable = true },
            { id = 226302, name = "Earthen Digging Fork", order = 44, clickable = true },
            { id = 226305, name = "Arathi Herb Pruner", order = 45, clickable = true },
            { id = 226304, name = "Arathi Garden Trowel", order = 46, clickable = true },
            { id = 226307, name = "Tunnelers Shovel", order = 47, clickable = true },
            { id = 226306, name = "Web Entangled Lotus", order = 48, clickable = true },
            { id = -1, name = "Inscription", order = 49 },
            { id = 226308, name = "Dornogal Scribes Quill", order = 50, clickable = true },
            { id = 226309, name = "Historians Dip Pen", order = 51, clickable = true },
            { id = 226311, name = "Blue Earthen Pigment", order = 52, clickable = true },
            { id = 226310, name = "Runic Scroll", order = 53, clickable = true },
            { id = 226313, name = "Calligraphers Chiseled Marker", order = 54, clickable = true },
            { id = 226312, name = "Informants Fountain Pen", order = 55, clickable = true },
            { id = 226314, name = "Nerubian Texts", order = 56, clickable = true },
            { id = 226315, name = "Venomancers Ink Well", order = 57, clickable = true },
            { id = -1, name = "Jewelcrafting", order = 58 },
            { id = 226317, name = "Earthen Gem Pliers", order = 59, clickable = true },
            { id = 226316, name = "Gentle Jewel Hammer", order = 60, clickable = true },
            { id = 226319, name = "Jewelers Delicate Drill", order = 61, clickable = true },
            { id = 226318, name = "Carved Stone File", order = 62, clickable = true },
            { id = 226321, name = "Librarians Magnifiers", order = 63, clickable = true },
            { id = 226320, name = "Arathi Sizing Gauges", order = 64, clickable = true },
            { id = 226323, name = "Nerubian Bench Blocks", order = 65, clickable = true },
            { id = 226322, name = "Ritual Casters Crystal", order = 66, clickable = true },
            { id = -1, name = "Leatherworking", order = 67 },
            { id = 226324, name = "Earthen Lacing Tools", order = 68, clickable = true },
            { id = 226325, name = "Dornogal Craftsmans Flat Knife", order = 69, clickable = true },
            { id = 226326, name = "Underground Stropping Compound", order = 70, clickable = true },
            { id = 226327, name = "Earthen Awl", order = 71, clickable = true },
            { id = 226329, name = "Arathi Leather Burnisher", order = 72, clickable = true },
            { id = 226328, name = "Arathi Beveler Set", order = 73, clickable = true },
            { id = 226331, name = "Curved Nerubian Skinning Knife", order = 74, clickable = true },
            { id = 226330, name = "Nerubian Tanning Mallet", order = 75, clickable = true },
            { id = -1, name = "Mining", order = 76 },
            { id = 224583, name = "Slab Of Slate", order = 77, clickable = true },
            { id = 224584, name = "Erosion Polished Slate", order = 78, clickable = true },
            { id = 226333, name = "Dornogal Chisel", order = 79, clickable = true },
            { id = 226332, name = "Earthen Miners Gavel", order = 80, clickable = true },
            { id = 226334, name = "Earthen Excavators Shovel", order = 81, clickable = true },
            { id = 226335, name = "Regenerating Ore", order = 82, clickable = true },
            { id = 226336, name = "Arathi Precision Drill", order = 83, clickable = true },
            { id = 226337, name = "Devout Archaeologists Excavator", order = 84, clickable = true },
            { id = 226338, name = "Heavy Spider Crusher", order = 85, clickable = true },
            { id = 226339, name = "Nerubian Mining Supplies", order = 86, clickable = true },
            { id = -1, name = "Skinning", order = 87 },
            { id = 224782, name = "Razor Talon", order = 88, clickable = true },
            { id = 225222, name = "Stone Leather Swatch", order = 89, clickable = true },
            { id = 225223, name = "Sturdy Nerubian Carapace", order = 90, clickable = true },
            { id = 224780, name = "Toughened Tempest Pelt", order = 91, clickable = true },
            { id = 224781, name = "Abyssal Fur", order = 92, clickable = true },
            { id = 226340, name = "Dornogal Carving Knife", order = 93, clickable = true },
            { id = 226341, name = "Earthen Workers Beams", order = 94, clickable = true },
            { id = 226342, name = "Artisans Drawing Knife", order = 95, clickable = true },
            { id = 226343, name = "Fungarians Rich Tannin", order = 96, clickable = true },
            { id = 226345, name = "Arathi Craftsmans Spokeshave", order = 97, clickable = true },
            { id = 226344, name = "Arathi Tanning Agent", order = 98, clickable = true },
            { id = 226347, name = "Carapace Shiner", order = 99, clickable = true },
            { id = 226346, name = "Nerubians Slicking Iron", order = 100, clickable = true },
            { id = -1, name = "Tailoring", order = 101 },
            { id = 226348, name = "Dornogal Seam Ripper", order = 102, clickable = true },
            { id = 226349, name = "Earthen Tape Measure", order = 103, clickable = true },
            { id = 226351, name = "Earthen Stitchers Snips", order = 104, clickable = true },
            { id = 226350, name = "Runed Earthen Pins", order = 105, clickable = true },
            { id = 226352, name = "Arathi Rotary Cutter", order = 106, clickable = true },
            { id = 226353, name = "Royal Outfitters Protractor", order = 107, clickable = true },
            { id = 226354, name = "Nerubian Quilt", order = 108, clickable = true },
            { id = 226355, name = "Nerubians Pincushion", order = 109, clickable = true },
        },
        Other = {
            { id = 210814, name = "Artisans Acuity", order = 1 },
        },
    },
    Other = {
        Other = {
