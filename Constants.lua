...
local ItemData = {
    ...
    TWW = {
        ...
        Pigment = {
            ...
            { id = -1, name = "Ink", order = 13 },
            { id = 222615, name = "Apricate Ink", order = 14, quality = 1 },
            { id = 222616, name = "Apricate Ink", order = 15, quality = 2 },
            { id = 222617, name = "Apricate Ink", order = 16, quality = 3 },
            { id = 222609, name = "Shadow Ink", order = 17, quality = 1 },
            { id = 222610, name = "Shadow Ink", order = 18, quality = 2 },
            { id = 222611, name = "Shadow Ink", order = 19, quality = 3 },
        },
        Knowledge = {
            { id = -1, name = "Alchemy", order = 1 },
            { id = 226265, name = "Earthen Iron Powder", order = 2 },
            { id = 226266, name = "Metal Dornogal Frame", order = 3 },
            { id = 226268, name = "Engraved Stirring Rod", order = 4 },
            { id = 226267, name = "Reinforced Beaker", order = 5 },
            { id = 226269, name = "Chemists Purified Water", order = 6 },
            { id = 226270, name = "Sanctified Mortar And Pestle", order = 7 },
            { id = 226272, name = "Dark Apothecarys Vial", order = 8 },
            { id = 226271, name = "Nerubian Mixing Salts", order = 9 },
            { id = -1, name = "Blacksmithing", order = 10 },
            { id = 226277, name = "Dornogal Hammer", order = 11 },
            { id = 226276, name = "Ancient Earthen Anvil", order = 12 },
            { id = 226278, name = "Ringing Hammer Vise", order = 13 },
            { id = 226279, name = "Earthen Chisels", order = 14 },
            { id = 226281, name = "Radiant Tongs", order = 15 },
            { id = 226280, name = "Holy Flame Forge", order = 16 },
            { id = 226283, name = "Spiderlings Wire Brush", order = 17 },
            { id = 226282, name = "Nerubian Smiths Kit", order = 18 },
            { id = -1, name = "Enchanting", order = 19 },
            { id = 226285, name = "Silver Dornogal Rod", order = 20 },
            { id = 226284, name = "Grinded Earthen Gem", order = 21 },
            { id = 226287, name = "Animated Enchanting Dust", order = 22 },
            { id = 226286, name = "Soot Coated Orb", order = 23 },
            { id = 226289, name = "Enchanted Arathi Scroll", order = 24 },
            { id = 226288, name = "Essence Of Holy Fire", order = 25 },
            { id = 226291, name = "Void Shard", order = 26 },
            { id = 226290, name = "Book Of Dark Magic", order = 27 },
            { id = -1, name = "Engineering", order = 28 },
            { id = 226293, name = "Dornogal Spectacles", order = 29 },
            { id = 226292, name = "Rock Engineers Wrench", order = 30 },
            { id = 226295, name = "Earthen Construct Blueprints", order = 31 },
            { id = 226294, name = "Inert Mining Bomb", order = 32 },
            { id = 226297, name = "Arathi Safety Gloves", order = 33 },
            { id = 226296, name = "Holy Firework Dud", order = 34 },
            { id = 226298, name = "Puppeted Mechanical Spider", order = 35 },
            { id = 226299, name = "Emptied Venom Canister", order = 36 },
            { id = -1, name = "Herbalism", order = 37 },
            { id = 224264, name = "Deepgrove Petal", order = 38 },
            { id = 224835, name = "Deepgrove Roots", order = 39 },
            { id = 224265, name = "Deepgrove Rose", order = 40 },
            { id = 226301, name = "Dornogal Gardening Scythe", order = 41 },
            { id = 226300, name = "Ancient Flower", order = 42 },
            { id = 226303, name = "Fungarian Slicers Knife", order = 43 },
            { id = 226302, name = "Earthen Digging Fork", order = 44 },
            { id = 226305, name = "Arathi Herb Pruner", order = 45 },
            { id = 226304, name = "Arathi Garden Trowel", order = 46 },
            { id = 226307, name = "Tunnelers Shovel", order = 47 },
            { id = 226306, name = "Web Entangled Lotus", order = 48 },
            { id = -1, name = "Inscription", order = 49 },
            { id = 226308, name = "Dornogal Scribes Quill", order = 50 },
            { id = 226309, name = "Historians Dip Pen", order = 51 },
            { id = 226311, name = "Blue Earthen Pigment", order = 52 },
            { id = 226310, name = "Runic Scroll", order = 53 },
            { id = 226313, name = "Calligraphers Chiseled Marker", order = 54 },
            { id = 226312, name = "Informants Fountain Pen", order = 55 },
            { id = 226314, name = "Nerubian Texts", order = 56 },
            { id = 226315, name = "Venomancers Ink Well", order = 57 },
            { id = -1, name = "Jewelcrafting", order = 58 },
            { id = 226317, name = "Earthen Gem Pliers", order = 59 },
            { id = 226316, name = "Gentle Jewel Hammer", order = 60 },
            { id = 226319, name = "Jewelers Delicate Drill", order = 61 },
            { id = 226318, name = "Carved Stone File", order = 62 },
            { id = 226321, name = "Librarians Magnifiers", order = 63 },
            { id = 226320, name = "Arathi Sizing Gauges", order = 64 },
            { id = 226323, name = "Nerubian Bench Blocks", order = 65 },
            { id = 226322, name = "Ritual Casters Crystal", order = 66 },
            { id = -1, name = "Leatherworking", order = 67 },
            { id = 226324, name = "Earthen Lacing Tools", order = 68 },
            { id = 226325, name = "Dornogal Craftsmans Flat Knife", order = 69 },
            { id = 226326, name = "Underground Stropping Compound", order = 70 },
            { id = 226327, name = "Earthen Awl", order = 71 },
            { id = 226329, name = "Arathi Leather Burnisher", order = 72 },
            { id = 226328, name = "Arathi Beveler Set", order = 73 },
            { id = 226331, name = "Curved Nerubian Skinning Knife", order = 74 },
            { id = 226330, name = "Nerubian Tanning Mallet", order = 75 },
            { id = -1, name = "Mining", order = 76 },
            { id = 224583, name = "Slab Of Slate", order = 77 },
            { id = 224584, name = "Erosion Polished Slate", order = 78 },
            { id = 226333, name = "Dornogal Chisel", order = 79 },
            { id = 226332, name = "Earthen Miners Gavel", order = 80 },
            { id = 226334, name = "Earthen Excavators Shovel", order = 81 },
            { id = 226335, name = "Regenerating Ore", order = 82 },
            { id = 226336, name = "Arathi Precision Drill", order = 83 },
            { id = 226337, name = "Devout Archaeologists Excavator", order = 84 },
            { id = 226338, name = "Heavy Spider Crusher", order = 85 },
            { id = 226339, name = "Nerubian Mining Supplies", order = 86 },
            { id = -1, name = "Skinning", order = 87 },
            { id = 224782, name = "Razor Talon", order = 88 },
            { id = 225222, name = "Stone Leather Swatch", order = 89 },
            { id = 225223, name = "Sturdy Nerubian Carapace", order = 90 },
            { id = 224780, name = "Toughened Tempest Pelt", order = 91 },
            { id = 224781, name = "Abyssal Fur", order = 92 },
            { id = 226340, name = "Dornogal Carving Knife", order = 93 },
            { id = 226341, name = "Earthen Workers Beams", order = 94 },
            { id = 226342, name = "Artisans Drawing Knife", order = 95 },
            { id = 226343, name = "Fungarians Rich Tannin", order = 96 },
            { id = 226345, name = "Arathi Craftsmans Spokeshave", order = 97 },
            { id = 226344, name = "Arathi Tanning Agent", order = 98 },
            { id = 226347, name = "Carapace Shiner", order = 99 },
            { id = 226346, name = "Nerubians Slicking Iron", order = 100 },
            { id = -1, name = "Tailoring", order = 101 },
            { id = 226348, name = "Dornogal Seam Ripper", order = 102 },
            { id = 226349, name = "Earthen Tape Measure", order = 103 },
            { id = 226351, name = "Earthen Stitchers Snips", order = 104 },
            { id = 226350, name = "Runed Earthen Pins", order = 105 },
            { id = 226352, name = "Arathi Rotary Cutter", order = 106 },
            { id = 226353, name = "Royal Outfitters Protractor", order = 107 },
            { id = 226354, name = "Nerubian Quilt", order = 108 },
            { id = 226355, name = "Nerubians Pincushion", order = 109 },
        },
        Other = {
            { id = 210814, name = "Artisans Acuity", order = 1 },
            { id = 221754, name = "Ringing Deeps Ingot", order = 2 },
            { id = 221756, name = "Vial Of Kaheti Oils", order = 3 },
        },
    },
    Other = {
        Other = {
