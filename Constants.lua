...
local ItemData = {
    ...
    DF = {
        ...
        Fish = {
            ...
            {id = 199344, name = "Magma Thresher", order = 7},
            {id = 200061, name = "Prismatic Leaper", order = 8},
            {id = 200074, name = "Frosted Rimefin Tuna", order = 9},
            {id = 199344, name = "Magma Thresher", order = 10},
            {id = -1, name = "Coins", order = 11},
            {id = 199338, name = "Copper Coin Of The Isles", order = 12},
            {id = 199339, name = "Silver Coin Of The Isles", order = 13},
            {id = 199340, name = "Gold Coin Of The Isles", order = 14},
            {id = -1, name = "Other", order = 15},
            {id = 198395, name = "Dull Spined Clam", order = 16},
        },
        Elemental = {
