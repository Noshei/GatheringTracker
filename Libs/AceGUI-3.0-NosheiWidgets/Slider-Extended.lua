...
Widget is an extension of the Slider Widget from AceGUI-3.0
Updated to use newer atlas files instead of old textures
-------------------------------------------------------------------------------]]
local Type, Version = "NW_Slider", 1
...
local function Constructor()
    ...
    lowtext:SetPoint("TOPLEFT", slider, "BOTTOMLEFT", 2, 2)

    local hightext = slider:CreateFontString(nil, "ARTWORK", "GameFontHighlightSmall")
    hightext:SetPoint("TOPRIGHT", slider, "BOTTOMRIGHT", -2, 2)
