...
local AGNW = LibStub:NewLibrary("AceGUI-3.0-NosheiWidgets-1.0", DataVersion)
...
do
    local function disable(frame)
        ...
        frame.dropButton.Text:SetTextColor(.5, .5, .5)
    ...
    local function enable(frame)
        ...
        frame.dropButton.Text:SetTextColor(1, .82, 0)
    ...
    function AGNW:GetBaseFrame()
        ...
        local dropButton = CreateFrame("DropdownButton", nil, frame, "WowStyle2DropdownTemplate")
        dropButton:ClearAllPoints()
        dropButton:SetPoint("TOPLEFT", frame, "TOPLEFT", 3, -16)
        dropButton:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", -5, 0)
    ...
    function AGNW:GetBaseFrameWithWindow()
...
do
    ...
    function AGNW:ReturnDropDownFrame(frame)
        ClearFrames(frame)
        frame:ClearAllPoints()
        frame:Hide()
        frame.backdrop:SetAtlas("common-dropdown-bg")
